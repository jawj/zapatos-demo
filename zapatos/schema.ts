...
It's been generated by Zapatos (v0.1.45), and is liable to be overwritten
...
export type Table = accounts.Table | appleTransactions.Table | authors.Table | books.Table | emailAuthentication.Table | employees.Table | stores.Table | tags.Table | tableInOtherSchema.Table;
export type Selectable = accounts.Selectable | appleTransactions.Selectable | authors.Selectable | books.Selectable | emailAuthentication.Selectable | employees.Selectable | stores.Selectable | tags.Selectable | tableInOtherSchema.Selectable;
export type Whereable = accounts.Whereable | appleTransactions.Whereable | authors.Whereable | books.Whereable | emailAuthentication.Whereable | employees.Whereable | stores.Whereable | tags.Whereable | tableInOtherSchema.Whereable;
export type Insertable = accounts.Insertable | appleTransactions.Insertable | authors.Insertable | books.Insertable | emailAuthentication.Insertable | employees.Insertable | stores.Insertable | tags.Insertable | tableInOtherSchema.Insertable;
export type Updatable = accounts.Updatable | appleTransactions.Updatable | authors.Updatable | books.Updatable | emailAuthentication.Updatable | employees.Updatable | stores.Updatable | tags.Updatable | tableInOtherSchema.Updatable;
export type UniqueIndex = accounts.UniqueIndex | appleTransactions.UniqueIndex | authors.UniqueIndex | books.UniqueIndex | emailAuthentication.UniqueIndex | employees.UniqueIndex | stores.UniqueIndex | tags.UniqueIndex | tableInOtherSchema.UniqueIndex;
export type Column = accounts.Column | appleTransactions.Column | authors.Column | books.Column | emailAuthentication.Column | employees.Column | stores.Column | tags.Column | tableInOtherSchema.Column;
export type AllTables = [accounts.Table, appleTransactions.Table, authors.Table, books.Table, emailAuthentication.Table, employees.Table, stores.Table, tags.Table, tableInOtherSchema.Table];

...
It's been generated by Zapatos (v5.0.3), and is liable to be overwritten
...
declare module 'zapatos/schema' {
  ...
  export namespace uk {
    ...
    export type legislatures = 'House of Commons' | 'House of Lords';
    export namespace every {
      export type legislatures = ['House of Commons', 'House of Lords'];
    }
    ...
    export namespace constituencies {
      export type Table = 'constituencies';
      export interface Selectable {
        /**
     ...
     * - Table in database
     */
    export namespace politicians {
      export type Table = 'politicians';
      export interface Selectable {
        /**
        * **uk.politicians.politicianId**
        * - `int4` in database
        * - `NOT NULL`, identity column
        */
        politicianId: number;
        ...
        */
        name: string;
        /**
        * **uk.politicians.legislatures**
        * - `legislatures` in database
        * - `NOT NULL`, no default
        */
        legislatures: legislatures;
        /**
        * **uk.politicians.constituencyId**
        * - `int4` in database
        * - Nullable, no default
        */
      ...
      export interface Whereable {
        ...
        * - `NOT NULL`, identity column
        */
        politicianId?: number | db.Parameter<number> | db.SQLFragment | db.ParentColumn | db.SQLFragment<any, number | db.Parameter<number> | db.SQLFragment | db.ParentColumn>;
        /**
        * **uk.politicians.name**
        * - `text` in database
        * - `NOT NULL`, no default
        ...
        * - `NOT NULL`, no default
        */
        legislatures?: legislatures | db.Parameter<legislatures> | db.SQLFragment | db.ParentColumn | db.SQLFragment<any, legislatures | db.Parameter<legislatures> | db.SQLFragment | db.ParentColumn>;
        /**
        * **uk.politicians.constituencyId**
        * - `int4` in database
        * - Nullable, no default
      ...
      export interface Insertable {
        ...
        * - `NOT NULL`, identity column
        */
        politicianId?: number | db.Parameter<number> | db.DefaultType | db.SQLFragment;
        /**
        * **uk.politicians.name**
        * - `text` in database
        * - `NOT NULL`, no default
        ...
        * - `NOT NULL`, no default
        */
        legislatures: legislatures | db.Parameter<legislatures> | db.SQLFragment;
        /**
        * **uk.politicians.constituencyId**
        * - `int4` in database
        * - Nullable, no default
        */
        constituencyId?: number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment;
      }
      export interface Updatable {
        /**
        * **uk.politicians.politicianId**
        ...
        * - `NOT NULL`, identity column
        */
        politicianId?: number | db.Parameter<number> | db.DefaultType | db.SQLFragment | db.SQLFragment<any, number | db.Parameter<number> | db.DefaultType | db.SQLFragment>;
        /**
        * **uk.politicians.name**
        * - `text` in database
        * - `NOT NULL`, no default
        ...
        * - `NOT NULL`, no default
        */
        legislatures?: legislatures | db.Parameter<legislatures> | db.SQLFragment | db.SQLFragment<any, legislatures | db.Parameter<legislatures> | db.SQLFragment>;
        /**
        * **uk.politicians.constituencyId**
        * - `int4` in database
        * - Nullable, no default
        */
        constituencyId?: number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment | db.SQLFragment<any, number | db.Parameter<number> | null | db.DefaultType | db.SQLFragment>;
      }
      export type UniqueIndex = 'politicians_pkey';
      export type Column = keyof Selectable;
      export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
      export type SQLExpression = Table | db.ColumnNames<Updatable | (keyof Updatable)[]> | db.ColumnValues<Updatable> | Whereable | Column | db.ParentColumn | db.GenericSQLExpression;
      export type SQL = SQLExpression | SQLExpression[];
  ...
  export namespace us {
    ...
    export type legislatures = 'Congress' | 'Senate';
    export namespace every {
      export type legislatures = ['Congress', 'Senate'];
    }
    ...
    export namespace politicians {
      ...
      export interface Selectable {
        ...
        */
        name: string;
        /**
        * **us.politicians.legislature**
        * - `legislatures` in database
        * - `NOT NULL`, no default
        */
        legislature: legislatures;
        /**
        * **us.politicians.stateId**
        * - `text` in database
        * - `NOT NULL`, no default
        */
        stateId: string;
      ...
      export interface Whereable {
        ...
        * - `NOT NULL`, no default
        */
        legislature?: legislatures | db.Parameter<legislatures> | db.SQLFragment | db.ParentColumn | db.SQLFragment<any, legislatures | db.Parameter<legislatures> | db.SQLFragment | db.ParentColumn>;
        /**
        * **us.politicians.stateId**
        * - `text` in database
        * - `NOT NULL`, no default
      ...
      export interface Insertable {
        ...
        * - `NOT NULL`, no default
        */
        legislature: legislatures | db.Parameter<legislatures> | db.SQLFragment;
        /**
        * **us.politicians.stateId**
        * - `text` in database
        * - `NOT NULL`, no default
      ...
      export interface Updatable {
        ...
        * - `NOT NULL`, no default
        */
        legislature?: legislatures | db.Parameter<legislatures> | db.SQLFragment | db.SQLFragment<any, legislatures | db.Parameter<legislatures> | db.SQLFragment>;
        /**
        * **us.politicians.stateId**
        * - `text` in database
        * - `NOT NULL`, no default
  ...
  export type Table = appleTransactions.Table | authors.Table | bankAccounts.Table | books.Table | bools.Table | chapters.Table | chat.Table | constituencies.Table | customTypes.Table | dimensions.Table | emailAuthentication.Table | employees.Table | files.Table | identityTest.Table | images.Table | int8test.Table | matBooks.Table | matCustom.Table | nameCounts.Table | numeric_mview.Table | numeric_test.Table | orderProducts.Table | orders.Table | paragraphs.Table | photos.Table | politicians.Table | politicians.Table | products.Table | states.Table | stores.Table | stringreturning.Table | subjectPhotos.Table | subjects.Table | tableInOtherSchema.Table | tags.Table | testview.Table | testviewnoins.Table | words.Table;
  export type Selectable = appleTransactions.Selectable | authors.Selectable | bankAccounts.Selectable | books.Selectable | bools.Selectable | chapters.Selectable | chat.Selectable | constituencies.Selectable | customTypes.Selectable | dimensions.Selectable | emailAuthentication.Selectable | employees.Selectable | files.Selectable | identityTest.Selectable | images.Selectable | int8test.Selectable | matBooks.Selectable | matCustom.Selectable | nameCounts.Selectable | numeric_mview.Selectable | numeric_test.Selectable | orderProducts.Selectable | orders.Selectable | paragraphs.Selectable | photos.Selectable | politicians.Selectable | politicians.Selectable | products.Selectable | states.Selectable | stores.Selectable | stringreturning.Selectable | subjectPhotos.Selectable | subjects.Selectable | tableInOtherSchema.Selectable | tags.Selectable | testview.Selectable | testviewnoins.Selectable | words.Selectable;
  export type JSONSelectable = appleTransactions.JSONSelectable | authors.JSONSelectable | bankAccounts.JSONSelectable | books.JSONSelectable | bools.JSONSelectable | chapters.JSONSelectable | chat.JSONSelectable | constituencies.JSONSelectable | customTypes.JSONSelectable | dimensions.JSONSelectable | emailAuthentication.JSONSelectable | employees.JSONSelectable | files.JSONSelectable | identityTest.JSONSelectable | images.JSONSelectable | int8test.JSONSelectable | matBooks.JSONSelectable | matCustom.JSONSelectable | nameCounts.JSONSelectable | numeric_mview.JSONSelectable | numeric_test.JSONSelectable | orderProducts.JSONSelectable | orders.JSONSelectable | paragraphs.JSONSelectable | photos.JSONSelectable | politicians.JSONSelectable | politicians.JSONSelectable | products.JSONSelectable | states.JSONSelectable | stores.JSONSelectable | stringreturning.JSONSelectable | subjectPhotos.JSONSelectable | subjects.JSONSelectable | tableInOtherSchema.JSONSelectable | tags.JSONSelectable | testview.JSONSelectable | testviewnoins.JSONSelectable | words.JSONSelectable;
  export type Whereable = appleTransactions.Whereable | authors.Whereable | bankAccounts.Whereable | books.Whereable | bools.Whereable | chapters.Whereable | chat.Whereable | constituencies.Whereable | customTypes.Whereable | dimensions.Whereable | emailAuthentication.Whereable | employees.Whereable | files.Whereable | identityTest.Whereable | images.Whereable | int8test.Whereable | matBooks.Whereable | matCustom.Whereable | nameCounts.Whereable | numeric_mview.Whereable | numeric_test.Whereable | orderProducts.Whereable | orders.Whereable | paragraphs.Whereable | photos.Whereable | politicians.Whereable | politicians.Whereable | products.Whereable | states.Whereable | stores.Whereable | stringreturning.Whereable | subjectPhotos.Whereable | subjects.Whereable | tableInOtherSchema.Whereable | tags.Whereable | testview.Whereable | testviewnoins.Whereable | words.Whereable;
  export type Insertable = appleTransactions.Insertable | authors.Insertable | bankAccounts.Insertable | books.Insertable | bools.Insertable | chapters.Insertable | chat.Insertable | constituencies.Insertable | customTypes.Insertable | dimensions.Insertable | emailAuthentication.Insertable | employees.Insertable | files.Insertable | identityTest.Insertable | images.Insertable | int8test.Insertable | matBooks.Insertable | matCustom.Insertable | nameCounts.Insertable | numeric_mview.Insertable | numeric_test.Insertable | orderProducts.Insertable | orders.Insertable | paragraphs.Insertable | photos.Insertable | politicians.Insertable | politicians.Insertable | products.Insertable | states.Insertable | stores.Insertable | stringreturning.Insertable | subjectPhotos.Insertable | subjects.Insertable | tableInOtherSchema.Insertable | tags.Insertable | testview.Insertable | testviewnoins.Insertable | words.Insertable;
  export type Updatable = appleTransactions.Updatable | authors.Updatable | bankAccounts.Updatable | books.Updatable | bools.Updatable | chapters.Updatable | chat.Updatable | constituencies.Updatable | customTypes.Updatable | dimensions.Updatable | emailAuthentication.Updatable | employees.Updatable | files.Updatable | identityTest.Updatable | images.Updatable | int8test.Updatable | matBooks.Updatable | matCustom.Updatable | nameCounts.Updatable | numeric_mview.Updatable | numeric_test.Updatable | orderProducts.Updatable | orders.Updatable | paragraphs.Updatable | photos.Updatable | politicians.Updatable | politicians.Updatable | products.Updatable | states.Updatable | stores.Updatable | stringreturning.Updatable | subjectPhotos.Updatable | subjects.Updatable | tableInOtherSchema.Updatable | tags.Updatable | testview.Updatable | testviewnoins.Updatable | words.Updatable;
  export type UniqueIndex = appleTransactions.UniqueIndex | authors.UniqueIndex | bankAccounts.UniqueIndex | books.UniqueIndex | bools.UniqueIndex | chapters.UniqueIndex | chat.UniqueIndex | constituencies.UniqueIndex | customTypes.UniqueIndex | dimensions.UniqueIndex | emailAuthentication.UniqueIndex | employees.UniqueIndex | files.UniqueIndex | identityTest.UniqueIndex | images.UniqueIndex | int8test.UniqueIndex | matBooks.UniqueIndex | matCustom.UniqueIndex | nameCounts.UniqueIndex | numeric_mview.UniqueIndex | numeric_test.UniqueIndex | orderProducts.UniqueIndex | orders.UniqueIndex | paragraphs.UniqueIndex | photos.UniqueIndex | politicians.UniqueIndex | politicians.UniqueIndex | products.UniqueIndex | states.UniqueIndex | stores.UniqueIndex | stringreturning.UniqueIndex | subjectPhotos.UniqueIndex | subjects.UniqueIndex | tableInOtherSchema.UniqueIndex | tags.UniqueIndex | testview.UniqueIndex | testviewnoins.UniqueIndex | words.UniqueIndex;
  export type Column = appleTransactions.Column | authors.Column | bankAccounts.Column | books.Column | bools.Column | chapters.Column | chat.Column | constituencies.Column | customTypes.Column | dimensions.Column | emailAuthentication.Column | employees.Column | files.Column | identityTest.Column | images.Column | int8test.Column | matBooks.Column | matCustom.Column | nameCounts.Column | numeric_mview.Column | numeric_test.Column | orderProducts.Column | orders.Column | paragraphs.Column | photos.Column | politicians.Column | politicians.Column | products.Column | states.Column | stores.Column | stringreturning.Column | subjectPhotos.Column | subjects.Column | tableInOtherSchema.Column | tags.Column | testview.Column | testviewnoins.Column | words.Column;
  ...
  export type SelectableForTable<T extends Table> = {
    ...
    constituencies: constituencies.Selectable;
    ...
    politicians: politicians.Selectable;
    politicians: politicians.Selectable;
  ...
  export type JSONSelectableForTable<T extends Table> = {
    ...
    constituencies: constituencies.JSONSelectable;
    ...
    politicians: politicians.JSONSelectable;
    politicians: politicians.JSONSelectable;
  ...
  export type WhereableForTable<T extends Table> = {
    ...
    chat: chat.Whereable;
    constituencies: constituencies.Whereable;
    ...
    politicians: politicians.Whereable;
    politicians: politicians.Whereable;
  ...
  export type InsertableForTable<T extends Table> = {
    ...
    constituencies: constituencies.Insertable;
    ...
    politicians: politicians.Insertable;
    politicians: politicians.Insertable;
  ...
  export type UpdatableForTable<T extends Table> = {
    ...
    chat: chat.Updatable;
    constituencies: constituencies.Updatable;
    ...
    politicians: politicians.Updatable;
    politicians: politicians.Updatable;
  ...
  export type UniqueIndexForTable<T extends Table> = {
    ...
    constituencies: constituencies.UniqueIndex;
    ...
    politicians: politicians.UniqueIndex;
    politicians: politicians.UniqueIndex;
  ...
  export type ColumnForTable<T extends Table> = {
    ...
    chat: chat.Column;
    constituencies: constituencies.Column;
    ...
    politicians: politicians.Column;
    politicians: politicians.Column;
  ...
  export type SQLForTable<T extends Table> = {
    ...
    chat: chat.SQL;
    constituencies: constituencies.SQL;
